...
public class Tools {
    ...
    public static String getFormattedDateSiapp(Long dateTime) {
        SimpleDateFormat newFormat = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
        return newFormat.format(new Date(dateTime));
    }
    public static String getFormattedDateSiapp2(Long dateTime) {
        SimpleDateFormat newFormat = new SimpleDateFormat("yyyy-MM-dd");
        return newFormat.format(new Date(dateTime));
    }
    public static String getFormattedDateSiapp3(Long dateTime) {
