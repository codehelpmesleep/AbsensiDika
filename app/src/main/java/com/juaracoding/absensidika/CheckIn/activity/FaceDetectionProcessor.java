...
import com.juaracoding.absensidika.mlkit.common.CameraImageGraphic;
import com.juaracoding.absensidika.mlkit.common.FrameMetadata;
...
public class FaceDetectionProcessor extends VisionProcessorBase<List<FirebaseVisionFace>> {
    ...
    public DataFromGraphic dataFromGraphic;


    //  private final Bitmap overlayBitmap;

    public FaceDetectionProcessor(Resources resources, DataFromGraphic dataFromGraphic) {
    ...
    protected void onSuccess(
        ...
        for (int i = 0; i < faces.size(); ++i) {
           ...
           // FaceGraphic faceGraphic = new FaceGraphic(graphicOverlay, face, cameraFacing, overlayBitmap);
            FaceGraphic faceGraphic = new FaceGraphic(graphicOverlay, face, cameraFacing,dataFromGraphic);
