...
public class FaceGraphic extends GraphicOverlay.Graphic  {
   ...
   // private final Bitmap overlayBitmap;
    ...
    public FaceGraphic(GraphicOverlay overlay, FirebaseVisionFace face, int facing, DataFromGraphic dataFromGraphic) {
        super(overlay);
 ...
 /*
          ...
          canvas.drawText(
                    "face2: " + String.format("%.2f",face.getHeadEulerAngleZ()),
                    x + ID_X_OFFSET * 6,
                    y,
                    idPaint); */

            if(face.getHeadEulerAngleY() > 35){
                dataFromGraphic.isFacingLeft(true);
            }else{
                dataFromGraphic.isFacingLeft(false);
            }

            if(face.getHeadEulerAngleY() < -35){
                dataFromGraphic.isFacingRight(true);
            }else{
