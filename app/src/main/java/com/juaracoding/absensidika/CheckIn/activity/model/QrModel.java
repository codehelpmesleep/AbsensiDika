...
public class QrModel implements Serializable, Parcelable
{
    ...
    public final static Creator<QrModel> CREATOR = new Creator<QrModel>() {
    ...
    ;
    private final static long serialVersionUID = -8541758457262070050L;
